...
export const AboutCard = ({ teacher }: IAboutCard) => {
    const router = useRouter();
    return (
        <div role="listitem" className="blog-item team w-dyn-item">
            <a onClick={() => router.push(TeacherPageUrl(teacher.id))} className="blog-image-wrapper w-inline-block">
                <img src={teacher.userImage} loading="lazy" alt="" className="blog-image" />
            </a>
            <div className="team-item-content">
                <div className="team-item-content-top">
                    <div className="team-title-wrapper">
                        <a onClick={() => router.push(TeacherPageUrl(teacher.id))} className="link-white w-inline-block">
                            <div className="text-size-large text-weight-semibold team-hover">
                ...
                <div className="w-layout-grid team-social">
