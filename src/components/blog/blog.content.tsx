...
export const BlogContent = ({ item }: IBlogContent) => {
    return (
        <section className="section-blogpost-rich-text">
            <ScrollFadeBox duration={0.5} className="page-padding">
                <div className="padding-bottom padding-xhuge">
                    <div className="padding-top padding-xxlarge">
                        <div className="container-small">
                            <div data-w-id="759888ac-eb03-447c-fd54-8fd047a9f725" className="blogpost-content">
                                <article className="text-rich-text w-richtext">
                                    <div dangerouslySetInnerHTML={{ __html: item.content }} />
                                </article>
                            </div>
                            <div data-w-id="759888ac-eb03-447c-fd54-8fd047a9f746" className="blogpost-content-bottom">
                                <div className="blogpost-author-wrapper">
                                    <a href="#" className="blogpost-author-image-wrapper w-inline-block">
                                        <img src={item.user.userImage} loading="lazy" alt="" className="blogpost-author-image" />
                                    </a>
                                    <div className="blogpost-author-text">
                                        <a href="#" className="blogpost-author-link w-inline-block">
                                            <div className="text-weight-semibold">
                                                {`${item.user.userFirstName} ${item.user.userLastName}`}
                                            </div>
                                        </a>
                                        <div>{item.user.grade}</div>
                                    </div>
                                </div>
                                <div className="blogpost-share-wrapper">
                                    <div className="text-size-medium text-weight-semibold">Share this post</div>
